// comes from https://github.com/PuruVJ/neoconfetti/blob/main/packages/core/src/index.ts

import styles from './confetti.module.css?inline';
import { c as c_container, p as c_particle } from './confetti.module.css?map';
